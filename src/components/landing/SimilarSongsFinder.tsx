...
export function SimilarSongsFinder({ user }: { user?: any }) {
      ...
      <section className="relative py-24 lg:py-32 bg-[#080811] text-white border-b border-[#16162A]">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="p-8 sm:p-12 rounded-3xl bg-[#0E0E1B] border-2 border-[#1E1E38] shadow-2xl relative overflow-hidden flex flex-col items-center justify-center min-h-[460px]">
            ...
            {!user ? (
              <div className="relative z-30 text-center space-y-4 max-w-md mx-auto p-6 rounded-2xl bg-[#080811]/90 border border-[#1DB954]/30 backdrop-blur-md">
                <div className="w-14 h-14 rounded-2xl bg-[#1DB954]/20 border border-[#1DB954]/40 flex items-center justify-center text-[#1DB954] mx-auto animate-pulse">
                  <svg className="w-7 h-7 fill-current" viewBox="0 0 24 24">
                    <path d="M18 8h-1V6c0-2.76-2.24-5-5-5S7 3.24 7 6v2H6c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V10c0-1.1-.9-2-2-2zm-6 9c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2zm3.1-9H8.9V6c0-1.71 1.39-3.1 3.1-3.1 1.71 0 3.1 1.39 3.1 3.1v2z"/>
                  </svg>
                </div>
                <h3 className="text-xl font-bold text-white">Sign In to Unlock Similarity Map</h3>
                <p className="text-xs text-slate-300">
                  Connect your Spotify account to explore similarity constellations, preview audio streams, and build playlists.
                </p>
                <button
                  onClick={() => setShowPortal(true)}
                  className="px-6 py-3 rounded-full bg-[#1DB954] hover:bg-[#1ed760] text-black font-extrabold text-xs uppercase tracking-wider transition-all inline-flex items-center gap-2 shadow-[0_0_20px_rgba(29,185,84,0.4)]"
                >
