          ...
          <div className="flex items-center gap-4">
            {user ? (
              <div className="flex items-center gap-3">
                ...
                <span className="text-xs font-semibold text-[#1DB954] hidden sm:block">
              ...
              <>
                ...
                <Link
                  href="#mood-discovery"
                  className="px-5 py-2.5 rounded-full bg-[#c2f0c2] hover:bg-[#a3e635] text-black text-xs font-bold tracking-wider uppercase transition-all duration-200 flex items-center gap-1.5 shadow-[0_0_20px_rgba(194,240,194,0.4)]"
                >
